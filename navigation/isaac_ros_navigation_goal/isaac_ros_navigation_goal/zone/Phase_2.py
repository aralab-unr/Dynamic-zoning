...
class Phase2(Phase1):
    def __init__(self):
        ...
        #140 #550 #750 #1000
        self.M = 1000 #number of reductions 100 is good

        self.adj_dist=249 #distance to be considered adjacent
        self.lowestSVp = 1
        self.all_path()
    ...
    def start_GA(self,exetime):
        ...
        pop_size = 60
        adj_range = 249
        gen_size = 100 #100 good
        selection_size = 10
        mutation_rate = 0.45
        self.lowestSVp = 1

        ws_neighbors = self.WS_neighbors(adj_range) #2D list
        #generate inial solution model
        initial_solws, initial_solcs = self.gen_solset(pop_size,adj_range,ws_neighbors)      
        ...
        while(gen < gen_size):
            ...
            if(self.countnum_ws(very_bestws) > 11): #for testing can delete later
                    print("error")
            ...
            #if bery best is better than opt then replace
            ...
            while p<pop_size:
                ...
                if wscount < self.num_ws:
                    ...
                    while(len(missingws) > 0):
                        ...
                        if path == None or dist > adj_range:
                            continue
                ...
                if(self.countnum_ws(solws) > 11): #for testing can delete later
                    print("error")
    ...
    def SA_improvement(self,exetime):
        ...
        while(c<cmax):
            ...
            for zone in range(0,num_zones):
                Lpz.append(self.zone_load(pc_ws[zone], all_tip_ws))
            ...
            '''
            self.update_adj_matrixs(temp_all_adj_matrix,temp_cs,self.adj_matrix)
            ...
            if path == None or dist > self.adj_dist: #check
                print(temp_cs)
            ...
            #df_adj1.to_csv(r'C:/home/russell/thesis_ws/src/navigation/isaac_ros_navigation_goal/isaac_ros_navigation_goal/zone/data/adj0.csv', header=self.all_points, index=self.all_points)
            #df_adj2.to_csv(r'C:/home/russell/thesis_ws/src/navigation/isaac_ros_navigation_goal/isaac_ros_navigation_goal/zone/data/adj1.csv', header=self.all_points, index=self.all_points)
            #df_adj3.to_csv(r'C:/home/russell/thesis_ws/src/navigation/isaac_ros_navigation_goal/isaac_ros_navigation_goal/zone/data/adj2.csv', header=self.all_points, index=self.all_points)
            ...
            if(new_SVp < self.lowestSVp):
                ...
                for zone in range(0,num_zones):
                    self.bestLpz[zone] = self.zone_load(pc_ws[zone], new_all_tip_ws)
