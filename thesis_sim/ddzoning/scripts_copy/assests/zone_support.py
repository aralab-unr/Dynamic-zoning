...
class Zone_func():
    def __init__(self, num_zone, adj_dist):
        ...
        self.workstation_loc = pd.read_csv(os.path.join(rospkg.RosPack().get_path('thesis_sim'), 'scripts/data/LE','station_location.csv'), sep=',', header=0, names=['x','y'], encoding = 'utf-8')
        self.adjacency_Mtx_pd = pd.read_csv(os.path.join(rospkg.RosPack().get_path('thesis_sim'), 'scripts/data/LE','map.csv'), sep=',', header=0, names=list(self.critical_points.index.values), encoding = 'utf-8')
        ...
        self.workstation_loads = pd.read_csv(os.path.join(rospkg.RosPack().get_path('thesis_sim'), 'scripts/data/LE','station_loads.csv'), sep=',', header=0, names=list(self.workstation_loc.index.values), encoding = 'utf-8')
