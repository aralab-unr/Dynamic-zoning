...
class Phase2(Phase1):
    def __init__(self):
        ...
        df_ws_dist_mtx.to_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_SA'), 'isaac_ros_navigation_goal_SA/zone_SA/data/LE','WS_dist_mtx.csv'), index=False)
    ...
    def SA_improvement(self,exetime):
        ...
        while(c<cmax):
            ...
            #df_adj1.to_csv(r'C:/home/russell/thesis_ws/src/navigation/isaac_ros_navigation_goal_SA/isaac_ros_navigation_goal_SA/zone_SA/data/adj0.csv', header=self.all_points, index=self.all_points)
            #df_adj2.to_csv(r'C:/home/russell/thesis_ws/src/navigation/isaac_ros_navigation_goal_SA/isaac_ros_navigation_goal_SA/zone_SA/data/adj1.csv', header=self.all_points, index=self.all_points)
            #df_adj3.to_csv(r'C:/home/russell/thesis_ws/src/navigation/isaac_ros_navigation_goal_SA/isaac_ros_navigation_goal_SA/zone_SA/data/adj2.csv', header=self.all_points, index=self.all_points)
