...
class Phase3(Phase2):
    def __init__(self, zone_ws, crit_seg, allAdjMatrix):
        ...
        workstation_dist_mtx = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_SA'), 'isaac_ros_navigation_goal_SA/zone_SA/data/LE','WS_dist_mtx.csv'), sep=',')
