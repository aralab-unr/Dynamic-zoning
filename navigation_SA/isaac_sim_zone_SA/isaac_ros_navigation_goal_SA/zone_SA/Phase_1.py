...
class Phase1:
      ...
      def read_csv(self):
            #var = os.path.join(rospkg.RosPack().get_path('isaac_ros_navigation_goal_SA'), 'isaac_ros_navigation_goal_SA/zone', 'Variables_of_Zone_Warehouse_Phase1.csv')
            #print(var)
            ...
            self.critical_points = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_SA'), 'isaac_ros_navigation_goal_SA/zone_SA/data/LE','Critical_Points.csv'), sep=',', header=0, names=['x','y'], encoding = 'utf-8')
            ...
            self.adjacency_Mtx_pd = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_SA'), 'isaac_ros_navigation_goal_SA/zone_SA/data/LE','Adjacency_matrix.csv'), sep=',', header=0, names=list(self.critical_points.index.values), encoding = 'utf-8')
            ...
            self.workstation_loads = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_SA'), 'isaac_ros_navigation_goal_SA/zone_SA/data/LE','Workstation_Loads.csv'), sep=',', header=0, names=list(self.workstation_loc.index.values), encoding = 'utf-8')
