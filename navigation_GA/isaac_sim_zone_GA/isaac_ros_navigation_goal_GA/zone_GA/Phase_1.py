...
class Phase1:
      ...
      def read_csv(self):
            #var = os.path.join(rospkg.RosPack().get_path('isaac_ros_navigation_goal_GA'), 'isaac_ros_navigation_goal_GA/zone', 'Variables_of_Zone_Warehouse_Phase1.csv')
            #print(var)
            ...
            self.adjacency_Mtx_pd = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data/LE','Adjacency_matrix.csv'), sep=',', header=0, names=list(self.critical_points.index.values), encoding = 'utf-8')
            ...
            self.workstation_loads = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data/LE','Workstation_Loads.csv'), sep=',', header=0, names=list(self.workstation_loc.index.values), encoding = 'utf-8')
