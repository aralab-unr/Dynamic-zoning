...
class part:
    ...
    def __init__(self,type,ID_num):
        ...
        times = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data/LE','processing_time.csv'), sep=',', header=0, names=['workstation','processing_time'], encoding = 'utf-8')
        self.workstations = times['workstation']
        self.processing_times = times['processing_time']
        variables_set = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data/LE', 'Variables_of_Zone_Warehouse_Phase1.csv'), sep=',', header=0, names=['value'], encoding = 'utf-8')
        ...
        processing_routes = pd.read_csv(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data/LE','processing_routes_test.csv'), sep=',', header=0, names=['part_type','route','qty'], encoding = 'utf-8')
        ...
        with open(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data','part_status.csv'), 'a') as file:
            line = writer(file)
    ...
    def add_cycleTime(self):
        with open(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data','cycle_times.csv'), 'a') as file:
    ...
    def write_status(self):
        myrow = []
        with open(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data','part_status.csv'), 'r') as file:
        ...
        with open(os.path.join(rospkg.RosPack().get_path('isaac_sim_zone_GA'), 'isaac_ros_navigation_goal_GA/zone_GA/data','part_status.csv'), 'w') as file:
